...
from .views import (AuthorDetailAPIView, AuthorListAPIView, CategorySpecialViews, 
    ...
    LikeCommentAPIView, LikeCommentDetailAPIView, LikeCommentEditAPIView, PostCommentsAPIView, PostListAPIViews, UserLikesListAPIView, 
    WomanCreateAPIView, WomanEditAPIView, WomanEditCommentView, WomanEditLikeUpdateView, WomanLeaveComment, WomanPutLikeCreateView, WomanPutLikeDetailListView, WomanPutLikeListView, 
    WomanSpecialViews)
...
urlpatterns = [
    ...
    path("posts/<slug:post_slug>/leave_comment/", WomanLeaveComment.as_view(), name="leave-comment"),
    path("posts/<slug:post_slug>/create_like/", WomanPutLikeCreateView.as_view(), name="create-like"),
    ...
    path("comments/<int:comment_id>/edit/", WomanEditCommentView.as_view(), name="edit-comment"),
